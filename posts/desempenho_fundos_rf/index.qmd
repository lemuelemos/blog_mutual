...
Pra fins de explocação de dados, vamos utilizar outra base de CVM conhecida como [Extrato de Informações](https://dados.cvm.gov.br/dataset/fi-doc-extrato) onde temos diversas informações relevantes dos fundos, que dizem respeito a informações qualitativas dos fundos de investimentos. 
